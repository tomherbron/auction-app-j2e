...
public class UtilisateurDAOJdbcImpl implements IUtilisateurDAO {
	...
	private static final String SELECT_BY_PSEUDO = "SELECT no_utilisateur, nom, prenom, email, telephone, rue, code_postal, ville, credit, administrateur, mot_de_passe FROM utilisateur WHERE pseudo=? ";
	...
	public Utilisateur selectByPseudo(String pseudo) throws DALException, SQLException {
		Utilisateur utilisateur = null;
		System.out.println("selectByPseudo  pseudo : " + pseudo);
		try (Connection con = ConnectionProvider.getConnection()) {
