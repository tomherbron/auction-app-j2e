	...
	<form method="post" action="./ServletGestionProfilUtilisateur">
	    ...
	    <div>
	      ...
	      <input type="text" id="ville-utilisateur" name="ville-utilisateur">
	     	...
	     	<div>
	      <label for="mdp-utilisateur">Mot de passe actuel : </label>
	      <input type="password" id="mdp-utilisateur" name="mdp-utilisateur-actuel"  pattern = "^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#$%^&*_=+-]).{8,16}$">
	    </div>
	   	<div>
	      <label for="mdp-utilisateur">Nouveau mot de passe : </label>
